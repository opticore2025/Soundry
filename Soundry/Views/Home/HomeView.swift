                    ...
                    LazyVStack(alignment: .leading, spacing: 0) {
                            ...
                            ZStack {
                                ...
                                HStack {
                                    VStack(alignment: .leading, spacing: 12) {  // 减少垂直间距
                                        ...
                                        {  // 减少副标题间距
                                            Text(
                                                "Enter your inspiration and generate"
                                            )
                        ...
                        if musicApiViewModel.musicHallData?.isEmpty ?? true {
                            ...
                            LazyVGrid(
                                ...
                                ForEach(
                                    musicApiViewModel.musicHallData ?? [],
                                    id: \.id
                                ) { musicItem in
                                    MusicItemView(
                                        musicItem: musicItem,
                                        userItem: musicItem.uid != nil
                                            ? musicApiViewModel
                            ...
                            .padding(
                                .bottom,
                                musicApiViewModel.musicHallHasMore ? 20 : 80
                            )
                            ...
                            if musicApiViewModel.musicHallHasMore {
                                VStack(spacing: 10) {
                                    HStack {
                                        ...
                                        if musicApiViewModel
                                            .isHomeMallLoadingMore
                                        {
                                            // 正在加载状态
                                            HStack {
                                                ProgressView()
                                ...
                                .onAppear {
                                    ...
                                    if !musicApiViewModel.isHomeMallLoadingMore
                                    {
                                        Task {
                                            print(
                                                "Auto loading more music hall data..."
                                            )
                                            let nextPage =
                                                musicApiViewModel
