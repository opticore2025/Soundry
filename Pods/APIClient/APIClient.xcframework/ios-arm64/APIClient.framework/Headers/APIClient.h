...
- (instancetype)initWithMoney:(APICLong * _Nullable)money __attribute__((swift_name("init(money:)"))) __attribute__((objc_designated_initializer));
...
- (APICPostAppleVerify200ResponseDataAccountInfo *)doCopyMoney:(APICLong * _Nullable)money __attribute__((swift_name("doCopy(money:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
 ...
 *   kotlinx.serialization.SerialName(value="balance")
*/
@property (readonly) APICLong * _Nullable money __attribute__((swift_name("money")));
@end
