 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)postAppleNoticePostAppleNoticeRequest:(APICPostAppleNoticeRequest *)postAppleNoticeRequest completionHandler:(void (^)(APICHttpResponse<APICPostAppleNotice200Response *> * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("postAppleNotice(postAppleNoticeRequest:completionHandler:)")));
...
@interface APICPostAppleNotice200Response : APICBase
...
@property (class, readonly, getter=companion) APICPostAppleNotice200ResponseCompanion *companion __attribute__((swift_name("companion")));
- (APICPostAppleNotice200Response *)doCopyStatus:(NSString * _Nullable)status __attribute__((swift_name("doCopy(status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface APICPostAppleNotice200ResponseCompanion : APICBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) APICPostAppleNotice200ResponseCompanion *shared __attribute__((swift_name("shared")));
- (id<APICKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface APICPostAppleNoticeRequest : APICBase
- (instancetype)initWithEnvironment:(APICPostAppleNoticeRequestEnvironment * _Nullable)environment transactionId:(NSString * _Nullable)transactionId notificationType:(APICPostAppleNoticeRequestNotificationType * _Nullable)notificationType notificationUuid:(NSString * _Nullable)notificationUuid __attribute__((swift_name("init(environment:transactionId:notificationType:notificationUuid:)"))) __attribute__((objc_designated_initializer));
@property (class, readonly, getter=companion) APICPostAppleNoticeRequestCompanion *companion __attribute__((swift_name("companion")));
- (APICPostAppleNoticeRequest *)doCopyEnvironment:(APICPostAppleNoticeRequestEnvironment * _Nullable)environment transactionId:(NSString * _Nullable)transactionId notificationType:(APICPostAppleNoticeRequestNotificationType * _Nullable)notificationType notificationUuid:(NSString * _Nullable)notificationUuid __attribute__((swift_name("doCopy(environment:transactionId:notificationType:notificationUuid:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
*/
@property (readonly) APICPostAppleNoticeRequestEnvironment * _Nullable environment __attribute__((swift_name("environment")));

/**
 * @note annotations
 *   kotlinx.serialization.SerialName(value="notification_type")
*/
@property (readonly) APICPostAppleNoticeRequestNotificationType * _Nullable notificationType __attribute__((swift_name("notificationType")));
...
@interface APICPostAppleNoticeRequestCompanion : APICBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) APICPostAppleNoticeRequestCompanion *shared __attribute__((swift_name("shared")));
- (id<APICKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
@end
...
@interface APICPostAppleNoticeRequestEnvironment : APICKotlinEnum<APICPostAppleNoticeRequestEnvironment *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) APICPostAppleNoticeRequestEnvironmentCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) APICPostAppleNoticeRequestEnvironment *sandbox __attribute__((swift_name("sandbox")));
@property (class, readonly) APICPostAppleNoticeRequestEnvironment *production __attribute__((swift_name("production")));
+ (APICKotlinArray<APICPostAppleNoticeRequestEnvironment *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<APICPostAppleNoticeRequestEnvironment *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *value __attribute__((swift_name("value")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostAppleNoticeRequest.EnvironmentCompanion")))
@interface APICPostAppleNoticeRequestEnvironmentCompanion : APICBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) APICPostAppleNoticeRequestEnvironmentCompanion *shared __attribute__((swift_name("shared")));
- (id<APICKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (id<APICKotlinx_serialization_coreKSerializer>)serializerTypeParamsSerializers:(APICKotlinArray<id<APICKotlinx_serialization_coreKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
@end
...
@interface APICPostAppleNoticeRequestNotificationType : APICKotlinEnum<APICPostAppleNoticeRequestNotificationType *>
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
- (instancetype)initWithName:(NSString *)name ordinal:(int32_t)ordinal __attribute__((swift_name("init(name:ordinal:)"))) __attribute__((objc_designated_initializer)) __attribute__((unavailable));
@property (class, readonly, getter=companion) APICPostAppleNoticeRequestNotificationTypeCompanion *companion __attribute__((swift_name("companion")));
@property (class, readonly) APICPostAppleNoticeRequestNotificationType *subscribed __attribute__((swift_name("subscribed")));
@property (class, readonly) APICPostAppleNoticeRequestNotificationType *didRenew __attribute__((swift_name("didRenew")));
@property (class, readonly) APICPostAppleNoticeRequestNotificationType *expired __attribute__((swift_name("expired")));
@property (class, readonly) APICPostAppleNoticeRequestNotificationType *didFailToRenew __attribute__((swift_name("didFailToRenew")));
@property (class, readonly) APICPostAppleNoticeRequestNotificationType *refund __attribute__((swift_name("refund")));
+ (APICKotlinArray<APICPostAppleNoticeRequestNotificationType *> *)values __attribute__((swift_name("values()")));
@property (class, readonly) NSArray<APICPostAppleNoticeRequestNotificationType *> *entries __attribute__((swift_name("entries")));
@property (readonly) NSString *value __attribute__((swift_name("value")));
@end

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("PostAppleNoticeRequest.NotificationTypeCompanion")))
@interface APICPostAppleNoticeRequestNotificationTypeCompanion : APICBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
@property (class, readonly, getter=shared) APICPostAppleNoticeRequestNotificationTypeCompanion *shared __attribute__((swift_name("shared")));
- (id<APICKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
- (id<APICKotlinx_serialization_coreKSerializer>)serializerTypeParamsSerializers:(APICKotlinArray<id<APICKotlinx_serialization_coreKSerializer>> *)typeParamsSerializers __attribute__((swift_name("serializer(typeParamsSerializers:)")));
@end
